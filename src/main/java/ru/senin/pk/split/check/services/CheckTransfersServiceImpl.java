...
/**
 * Service implementation that calculates optimal transfers for check
 */
@Service
public class CheckTransfersServiceImpl implements CheckTransfersService {

    private static final Logger LOGGER = LoggerFactory.getLogger(CheckTransfersServiceImpl.class);
